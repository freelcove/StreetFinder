...
//     const [playList, setPlayList] = useState<Array<{id: number, name: string, visits:number}> | null>([]);
//     const [arr, setArr] = useState<Array<{id: number, name: string, visits:number}> | null>([]);
...
//         const newArr = [...arr, { id: num, name: data.place_name, visits: data.visits }];
...
//             const dist = calculateDistance(userCoordinates.lat, userCoordinates.lng, coordinates.lat, coordinates.lng);
//             setDistance(dist);
