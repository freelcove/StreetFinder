                ...
                coordinates && (
                    <>
                        <div className="relative w-full h-full overflow-hidden z-0">
                            ...
                            <div className="absolute bottom-5 right-5 w-[20%] aspect-[4/3] bg-white opacity-40 hover:w-[30%] origin-bottom-right hover:opacity-100 transition-all duration-200 z-40">
                                <Map />
                                ...
                                <button
                                    ...
                                    className={`absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 bg-blue-500 text-white px-4 py-2 rounded ${!userCoordinates ? "opacity-50 cursor-not-allowed" : ""
                                        }`}
                                >
